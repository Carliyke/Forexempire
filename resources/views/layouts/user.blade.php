      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo"><h3>Dashboard</h3></a>
          </div>
      ...
      <footer class="footer">
        <div class=" container-fluid ">
          ...
          <div class="copyright" id="copyright">
            ...
            </script>, Designed by <a href="https://www.tallHOWS.com" target="_blank">Carlyke</a>. Powered by <a href="https://www.carliyke.com" target="_blank">tallHOWS</a>.
          </div>
        </div>
      </footer>
    </div>
